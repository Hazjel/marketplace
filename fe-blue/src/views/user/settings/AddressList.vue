...
<template>
  <div class="flex flex-col gap-6">
    ...
    <div
      ...
      class="flex flex-col items-center justify-center py-20 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200"
    >
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      >
        <div
          ...
          class="absolute top-4 right-4 px-3 py-1 bg-custom-blue/10 text-custom-blue text-xs font-bold rounded-full"
        >
          Primary Address
        </div>
