                            ...
                            <div class="grid grid-cols-2 gap-6 h-[76px]">
                                <label
                                    ...
                                    <div
                                        ...
                                        <img src="@/assets/images/icons/shop-grey.svg" class="flex size-6 shrink-0"
                                            alt="icon">
                                    </div>
                                    ...
                                    <input type="radio" name="type" value="store" id="" class="absolute opacity-0" v-model="form.role">
                                </label>
                                <label
                                    class="group relative flex items-center h-full py-4 px-5 gap-4 rounded-[18px] border-[2px] border-custom-border focus-within:border-custom-black transition-300 w-full">
                                    <div
                                        class="flex h-[28px] shrink-0 items-center pr-4 pl-1 border-r-[1.5px] border-custom-border ">
                                        <img src="@/assets/images/icons/bag-2-grey.svg" class="flex size-6 shrink-0"
                                            alt="icon">
                                    </div>
                                    <p class="font-bold leading-none w-full">
                                        Buyer
                                    ...
                                    <input type="radio" name="type" value="buyer" id="" class="absolute opacity-0" v-model="form.role">
                                </label>
                            </div>
                        </div>
                        <div class="flex flex-col gap-3">
