    ...
    <div class="rounded-2xl bg-gradient-to-r from-green-600 to-emerald-600 p-6 shadow-sm">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1 class="text-2xl font-bold text-white">Saldo Toko</h1>
            <p class="text-green-100">Kelola semua saldo toko yang terdaftar</p>
          </div>
        </div>
        <div class="flex items-center gap-2 rounded-xl bg-white/20 px-4 py-2">
          ...
          <span class="font-semibold text-white">{{ storeBalances.length }} Total</span>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-col flex-1 rounded-2xl border border-gray-100 dark:border-white/10 bg-white dark:bg-surface-card shadow-sm p-6 gap-6">
      ...
      <div
        ...
        <div class="flex flex-col gap-1 items-center text-center">
          <p class="font-semibold text-gray-900 dark:text-white">Belum ada data saldo</p>
          <p class="text-sm text-gray-500 dark:text-gray-400">Data saldo toko akan muncul di sini</p>
        </div>
      </div>
    </div>
  </div>
