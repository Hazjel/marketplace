                    ...
                    <section class="flex flex-col w-full rounded-[20px] p-5 gap-5 bg-white">
                        ...
                        <div class="flex items-center gap-[14px] w-full min-w-0">
                            <div class="flex size-[92px] shrink-0 rounded-full bg-custom-background overflow-hidden">
                                <img :src="storeBalance?.store?.logo" class="size-full object-cover"
                                    alt="photo">
                            </div>
                        ...
                        <div class="flex flex-col rounded-[20px] border border-custom-stroke p-4 gap-5">
                            <div class="flex items-center gap-[10px] w-[260px]">
                                ...
                                <div class="flex flex-col gap-1">
                                    <p class="font-bold text-lg leading-none">3</p>
                            ...
                            <div class="flex items-center gap-[10px] w-[260px]">
                                ...
                                <div class="flex flex-col gap-1">
                                    <p class="font-bold text-lg leading-none">1</p>
                    ...
                    <div class="header flex items-center justify-between">
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <p class="font-semibold text-custom-grey">4 Total Withdrawal</p>
                            </div>
                        </div>
                    ...
                    <section id="List-Withdrawal" class="flex flex-col flex-1 gap-6 w-full">
                        <div class="list flex flex-col gap-5">
                            <div
                                ...
                                <div class="flex items-center gap-[14px] flex-1">
                                    <div
                                        ...
                                        <img src="@/assets/images/icons/card-send-orange-fill.svg"
                                            class="size-full object-contain" alt="icon">
                                    </div>
                                    <div class="flex flex-col gap-[6px]">
                                        <p class="font-bold text-[22px] text-custom-orange">Rp 320.000</p>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-[14px] flex-1">
                                    <div
                                        class="flex size-[72px] rounded-2xl overflow-hidden items-center justify-center p-5 bg-custom-green/10">
                                        <img src="@/assets/images/icons/card-tick-green-fill.svg"
                                            class="size-full object-contain" alt="icon">
                                    </div>
                                    <div class="flex flex-col gap-[6px]">
                                        <p class="font-bold text-[22px] text-custom-orange">Rp 320.000</p>
