...
<template>
  <div class="flex flex-col gap-6">
    <DashboardPageHeader
      ...
      subtitle="Kelola semua permintaan penarikan"
      ...
      <template #actions>
        <div class="flex items-center gap-2 rounded-xl bg-white/20 px-4 py-2">
          ...
          <span class="font-medium text-white">{{ withdrawals.length }} Total</span>
        </div>
      </template>
    </DashboardPageHeader>
    ...
    <div class="flex flex-col flex-1 rounded-2xl border border-gray-100 dark:border-white/10 bg-white dark:bg-surface-card shadow-sm p-6 gap-6">
      ...
      <section id="List-Transactions" class="flex flex-col flex-1 gap-6 w-full">
        <div v-if="!loading && withdrawals" class="list flex flex-col gap-4">
          <CardList
      ...
      <div
        ...
        <div class="flex flex-col gap-1 items-center text-center">
          <p class="font-medium text-gray-900 dark:text-white">Belum ada permintaan penarikan</p>
