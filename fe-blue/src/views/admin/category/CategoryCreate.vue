  ...
  <form class="flex flex-col w-full rounded-3xl p-5 gap-5 bg-white" @submit.prevent="handleSubmit">
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center justify-between w-1/2">
        ...
        <Button id="Add-Photo" type="button" variant="secondary"> Add Photo </Button>
      </div>
    </div>
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="w-1/2">
        <Input v-model="productCategory.name" label="Enter Category Name" :error="error?.name">
          <template #icon>
            <img
              src="@/assets/images/icons/note-grey.svg"
              class="flex size-6 shrink-0"
    ...
    <div class="flex items-center justify-end gap-4">
      ...
      <Button type="submit" variant="primary" :loading="loading"> Create Now </Button>
    </div>
  </form>
</template>
