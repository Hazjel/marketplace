    ...
    <div v-if="productCategory.parent_id" class="flex items-center justify-between">
      ...
      >
        <label class="group relative">
          ...
          <p class="input-placeholder">Enter Category Parent</p>
          <input
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="group/errorState flex flex-col gap-2 w-1/2" :class="{ invalid: error?.name }">
        <label class="group relative">
          ...
          <p class="input-placeholder">Enter Category Name</p>
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="group/errorState flex flex-col gap-2 w-1/2" :class="{ invalid: error?.tagline }">
        <label class="group relative">
          ...
          <p class="input-placeholder">Enter Tagline Category</p>
          <input
