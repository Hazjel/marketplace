          ...
          <div class="flex flex-col md:flex-row gap-4 w-full">
            <div class="group/errorState flex flex-col gap-2 w-full">
              ...
              >
                ...
                <p
                  class="placeholder font-bold absolute -translate-y-1/2 left-[81px] top-[25px] transition-300"
                  :class="
                    product.parent_product_category_id
            ...
            >
              ...
              >
                ...
                <p
                  class="placeholder font-bold absolute -translate-y-1/2 left-[81px] top-[25px] transition-300"
                  :class="
                    product.product_category_id ? 'text-sm text-custom-grey font-semibold' : ''
                  "
                >
                  Select Sub Category
                </p>
            ...
            >
              ...
              <div class="flex flex-wrap gap-2">
                ...
                >
                  ...
                  <button
                    type="button"
                    class="hover:text-red-500 text-lg leading-none"
              ...
              >
                ...
                <div class="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    type="text"
                    class="custom-input h-10 text-sm bg-gray-50"
                    placeholder="Name"
                  />
                </div>
          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full">
            ...
            >
              ...
              <img
                ...
                class="thumbnail pointer-events-none"
                alt="icon"
              />
