    ...
    <div class="flex flex-1 gap-5">
        <section class="flex flex-col w-full h-fit rounded-[20px] p-5 gap-5 bg-white">
            <div class="flex items-center gap-[14px] overflow-hidden">
                <div class="flex size-[92px] shrink-0 rounded-2xl bg-custom-background overflow-hidden items-center justify-center">
                    <img :src="product?.product_images?.find(image => image.is_thumbnail)?.image" class="size-full object-contain" alt="icon">
                </div>
        ...
        <section class="flex flex-col w-[435px] shrink-0 h-fit rounded-[20px] p-5 gap-5 bg-white">
            <div class="grid grid-cols-3 gap-4">
                <div data-modal="Gallery-Modal" data-index="1" data-gallery="../assets/images/thumbnails/macbook-pro-m2.png" class="relative flex h-[121px] rounded-2xl bg-custom-background overflow-hidden" v-for="image in product?.product_images">
