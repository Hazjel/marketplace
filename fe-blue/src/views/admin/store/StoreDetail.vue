  ...
  <div class="flex gap-5">
    <div class="flex flex-col gap-5 w-full animate-fade-in-up">
      ...
      <section
        ...
        class="flex flex-col w-full h-fit rounded-[20px] p-5 gap-5 bg-white"
      >
        ...
        <div class="flex flex-col rounded-[20px] border border-custom-stroke p-4 gap-5">
          ...
          <div class="flex items-center gap-[10px] w-[260px]">
            ...
            >
              <img
                src="@/assets/images/icons/shop-add-black.svg"
                class="flex size-6 shrink-0"
                alt="icon"
              />
            </div>
    ...
    <section
      class="flex flex-col w-full h-fit rounded-[20px] p-5 gap-5 bg-white animate-fade-in-up delay-100"
    >
