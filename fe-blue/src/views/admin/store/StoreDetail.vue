    ...
    <div class="flex flex-col gap-6 w-full lg:w-3/5 animate-fade-in-up">
      ...
      >
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div class="flex items-center gap-3 p-4 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-white/10">
            <div class="flex size-11 shrink-0 rounded-xl bg-[#024ad8]/10 dark:bg-[#024ad8]/20 items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-[#024ad8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="flex flex-col gap-3">
          <div class="flex items-center gap-3">
            ...
            <RouterLink
              ...
              class="flex items-center justify-center h-12 w-full rounded-2xl gap-2 bg-gradient-to-r from-[#024ad8] to-blue-700 hover:shadow-lg hover:shadow-[#024ad8]/25 transition-all"
            >
      ...
      >
        ...
        <div class="flex flex-col gap-3">
          <div class="flex items-center gap-3">
            <a
              class="flex items-center justify-center h-12 w-full rounded-2xl gap-2 bg-gradient-to-r from-[#024ad8] to-blue-700 hover:shadow-lg hover:shadow-[#024ad8]/25 transition-all cursor-pointer"
