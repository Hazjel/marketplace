  ...
  <div class="flex flex-col flex-1 rounded-[20px] p-5 gap-6 bg-white">
    <div class="header flex flex-col md:flex-row items-center justify-between gap-5">
      ...
      >
        <button
          type="button"
          class="tab-btn group w-full shrink-0"
          :class="{ active: filters.is_verified }"
        ...
        >
          ...
          >
            <span
              class="font-semibold group-[&.active]:text-white text-custom-grey transition-300 text-nowrap"
              >Verified Store</span
            >
          </div>
        </button>
