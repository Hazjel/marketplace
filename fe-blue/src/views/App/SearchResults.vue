...
useHead({
  title: computed(() =>
    searchQuery.value ? `Search: ${searchQuery.value} | Blukios` : 'Search | Blukios'
  ),
  meta: [
    {
      name: 'description',
...
<template>
  ...
  >
    ...
    <div class="flex flex-col gap-10 md:gap-[80px] w-full">
      ...
      <section
        v-else-if="
          !loadingProducts && products.length === 0 && !loadingStores && stores.length === 0
        "
      ...
      >
        <div class="flex flex-col items-center gap-4">
          <img
            ...
            class="size-20 opacity-50 dark:brightness-0 dark:invert"
            alt="No results"
          />
