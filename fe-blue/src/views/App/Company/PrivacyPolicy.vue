    ...
    <main class="w-full bg-white pb-20">
        ...
        <header class="bg-gray-50 border-b border-gray-200 py-16 md:py-20 px-5 md:px-[52px]">
            <div class="max-w-[1280px] mx-auto">
                <span class="text-custom-blue font-bold tracking-widest uppercase text-sm mb-4 block">Legal</span>
                ...
                <p class="text-custom-grey text-lg max-w-2xl">
                    We are committed to protecting your privacy and ensuring your data is handled with transparency and
                    care.
                </p>
                <div
        ...
        <div class="max-w-[1280px] mx-auto px-5 md:px-[52px] py-12 flex flex-col md:flex-row gap-12 relative">
            <!-- Sidebar Navigation -->
            <aside class="w-full md:w-1/4 hidden md:block">
                <div class="sticky top-32 flex flex-col gap-2">
                    <p class="font-bold text-custom-black mb-2 px-4 uppercase text-xs tracking-wider">Contents</p>
                    <button @click="scrollTo('introduction')"
                        :class="activeSection === 'introduction' ? 'bg-blue-50 text-custom-blue font-bold border-custom-blue' : 'text-custom-grey hover:bg-gray-50 border-transparent'"
                        class="text-left px-4 py-3 rounded-lg text-sm transition-all border-l-4">
                        1. Introduction
                    </button>
                    <button @click="scrollTo('collection')"
                        :class="activeSection === 'collection' ? 'bg-blue-50 text-custom-blue font-bold border-custom-blue' : 'text-custom-grey hover:bg-gray-50 border-transparent'"
                        class="text-left px-4 py-3 rounded-lg text-sm transition-all border-l-4">
                        2. Data We Collect
                    </button>
                    <button @click="scrollTo('usage')"
                        :class="activeSection === 'usage' ? 'bg-blue-50 text-custom-blue font-bold border-custom-blue' : 'text-custom-grey hover:bg-gray-50 border-transparent'"
                        class="text-left px-4 py-3 rounded-lg text-sm transition-all border-l-4">
                        3. How We Use Data
                    </button>
                    <button @click="scrollTo('security')"
                        :class="activeSection === 'security' ? 'bg-blue-50 text-custom-blue font-bold border-custom-blue' : 'text-custom-grey hover:bg-gray-50 border-transparent'"
                        class="text-left px-4 py-3 rounded-lg text-sm transition-all border-l-4">
                        4. Data Security
                    </button>
                    <button @click="scrollTo('contact')"
                        :class="activeSection === 'contact' ? 'bg-blue-50 text-custom-blue font-bold border-custom-blue' : 'text-custom-grey hover:bg-gray-50 border-transparent'"
                        class="text-left px-4 py-3 rounded-lg text-sm transition-all border-l-4">
                        5. Contact Us
                    </button>
                </div>
                ...
                <div
                    ...
                    <section id="introduction" class="scroll-mt-32">
                        ...
                        <p class="text-base leading-relaxed">
                            Welcome to Blukios. We respect your privacy and are committed to protecting your personal
                        ...
                        <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                            <ul class="space-y-3 list-none p-0 m-0">
                                <li class="flex gap-3">
                                    ...
                                    <span class="text-sm"><strong>Identity Data:</strong> First name, maiden name, last
                                        name, username or similar identifier.</span>
                                </li>
                                <li class="flex gap-3">
                                    <div class="w-1.5 h-1.5 rounded-full bg-custom-blue mt-2 shrink-0"></div>
                                    <span class="text-sm"><strong>Contact Data:</strong> Billing address, delivery
                                        address, email address and telephone numbers.</span>
                                </li>
                                <li class="flex gap-3">
                                    <div class="w-1.5 h-1.5 rounded-full bg-custom-blue mt-2 shrink-0"></div>
                                    <span class="text-sm"><strong>Financial Data:</strong> Bank account and payment card
                                        details (processed securely).</span>
                                </li>
                                <li class="flex gap-3">
                                    <div class="w-1.5 h-1.5 rounded-full bg-custom-blue mt-2 shrink-0"></div>
                                    <span class="text-sm"><strong>Transaction Data:</strong> Details about payments to
                                        and from you.</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <section id="usage" class="scroll-mt-32">
                        ...
                        <ul class="space-y-2 list-disc pl-5">
                            <li class="pl-2">Where we need to perform the contract we are about to enter into or have
                                entered into with you.</li>
                            <li class="pl-2">Where it is necessary for our legitimate interests (or those of a third
                                party) and your interests and fundamental rights do not override those interests.</li>
                    ...
                    <section id="contact" class="scroll-mt-32">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-custom-grey mb-1">Our data protection officer is ready to help
                                    you.</p>
                                <a href="mailto:privacy@blukios.com"
                                    class="text-custom-blue font-semibold hover:underline">privacy@blukios.com</a>
                            </div>
                        </div>
                    </section>
                </div>
