<template>
    <div class="flex gap-5">
                    <div class="flex flex-col w-[360px] shrink-0 rounded-[20px] p-5 gap-6 bg-white">
                        <div class="flex flex-col gap-6">
                            <div class="flex size-[56px] bg-custom-blue/10 items-center justify-center rounded-full">
                                <img src="@/assets/images/icons/wallet-2-blue-fill.svg" class="flex size-6 shrink-0"
                                    alt="icon">
                            </div>
                    ...
                    <div class="flex flex-col w-full rounded-[20px] p-5 gap-6 bg-white">
                        <div class="flex flex-col gap-6">
                            <div class="flex size-[56px] bg-custom-blue/10 items-center justify-center rounded-full">
                                <img src="@/assets/images/icons/shopping-cart-blue-fill.svg"
                    ...
                    <div class="flex flex-col w-full rounded-[20px] p-5 gap-6 bg-white">
                        <div class="flex flex-col gap-6">
                            <div class="flex size-[56px] bg-custom-blue/10 items-center justify-center rounded-full">
                                <img src="@/assets/images/icons/profile-2user-blue-fill.svg"
                                    class="flex size-6 shrink-0" alt="icon">
                            </div>
                            <div class="flex flex-col gap-[6px]">
                ...
                <div class="flex gap-5 flex-1">
                    <div class="flex flex-col gap-5 w-[470px] shrink-0">
                        <div class="flex flex-col flex-1 rounded-[20px] p-5 gap-6 bg-white">
                            <div class="flex flex-col gap-6">
                                <div
                                    class="flex size-[56px] bg-custom-blue/10 items-center justify-center rounded-full">
                                    <img src="@/assets/images/icons/stickynote-blue-fill.svg"
                                        class="flex size-6 shrink-0" alt="icon">
                                </div>
                                <div class="flex flex-col gap-[6px]">
                            ...
                            <div class="flex flex-col flex-1 gap-5">
                                            ...
                                            <div class="flex items-center gap-[10px] min-w-0">
                                                ...
                                                <div class="flex flex-col gap-[6px] w-full overflow-hidden">
                                                    ...
                                                    <p
                                                        ...
                                                        <img src="@/assets/images/icons/call-grey.svg" class="size-5"
                                                            alt="icon">
                                                        081255553005
                                                    </p>
                                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-[10px] min-w-0">
                                                <div
                                                    class="flex size-14 shrink-0 rounded-full bg-custom-background overflow-hidden">
                                                    <img src="@/assets/images/photos/photo-2.png"
                                                        class="size-full object-cover" alt="photo">
                                                </div>
                                                <div class="flex flex-col gap-[6px] w-full overflow-hidden">
                                                    <p class="font-bold text-lg leading-tight w-full truncate">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-[10px] min-w-0">
                                                <div
                                                    class="flex size-14 shrink-0 rounded-full bg-custom-background overflow-hidden">
                                                    <img src="@/assets/images/photos/photo-3.png"
                                                        class="size-full object-cover" alt="photo">
                                                </div>
                                                <div class="flex flex-col gap-[6px] w-full overflow-hidden">
                                                    <p class="font-bold text-lg leading-tight w-full truncate">
                                ...
                                <div id="Empty-State"
                                    class="hidden flex flex-col flex-1 items-center justify-center gap-4">
                                    <img src="@/assets/images/icons/note-remove-grey.svg" class="size-[52px]"
                                        alt="icon">
                    ...
                    <div class="flex flex-col flex-1 w-full rounded-[20px] p-5 gap-6 bg-white">
                        <div class="flex flex-col gap-6">
                            <div class="flex size-[56px] bg-custom-blue/10 items-center justify-center rounded-full">
                                <img src="@/assets/images/icons/message-text-blue-fill.svg"
                                    class="flex size-6 shrink-0" alt="icon">
                            </div>
                            <div class="flex flex-col gap-[6px]">
                            ...
                            <div id="List-Reviews" class="flex flex-col gap-5">
                                <div
                                    ...
                                    <div class="flex items-center gap-[10px] min-w-0">
                                        <div
                                            class="flex size-14 shrink-0 rounded-full bg-custom-background overflow-hidden">
                                            <img src="@/assets/images/photos/photo-8.png"
                                                class="size-full object-cover" alt="photo">
                                        </div>
                                        <div class="flex flex-col gap-[6px] w-full overflow-hidden">
                                            <p class="font-bold text-lg leading-tight w-full truncate">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <div class="flex">
                                            <img src="@/assets/images/icons/Star-pointy.svg"
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-[10px] min-w-0">
                                        <div
                                            class="flex size-14 shrink-0 rounded-full bg-custom-background overflow-hidden">
                                            <img src="@/assets/images/photos/photo-7.png"
                                                class="size-full object-cover" alt="photo">
                                        </div>
                                        <div class="flex flex-col gap-[6px] w-full overflow-hidden">
                                            <p class="font-bold text-lg leading-tight w-full truncate">
