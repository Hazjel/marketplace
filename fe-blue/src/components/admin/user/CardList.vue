...
<template>
    <div class="card flex flex-col md:flex-row items-start md:items-center rounded-[20px] border border-custom-stroke py-[18px] px-5 gap-6 bg-white">
        <div class="flex items-center gap-[14px] w-full md:w-full min-w-0">
        ...
        <div class="flex items-center gap-[10px] w-full">
            <div
                ...
                <img src="@/assets/images/icons/profile-tick-black.svg" class="flex size-6 shrink-0" alt="icon">
            </div>
