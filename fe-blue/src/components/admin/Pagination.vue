...
<template>
  <nav id="Pagination">
    <ul class="flex items-center gap-1 md:gap-3">
      <li class="group">
        ...
        >
          <img
            ...
            class="size-5 md:size-6 group-has-[:disabled]:opacity-20 rotate-180"
            alt="icon"
          />
        </button>
      </li>
      ...
      <li
        v-for="page in getPageNumbers(meta.current_page, meta.last_page)"
        :key="page"
        class="group"
      ...
      <li class="group">
        ...
        >
          <img
            src="@/assets/images/icons/arrow-right-no-tail-blue.svg"
            class="size-5 md:size-6 group-has-[:disabled]:opacity-20"
            alt="icon"
          />
        </button>
      </li>
