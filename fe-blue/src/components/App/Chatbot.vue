    ...
    <template>
        <div class="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3 font-sans">
            ...
            <button @click="toggleChat"
                class="w-14 h-14 bg-custom-blue rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-300 text-white text-2xl">
