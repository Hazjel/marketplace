...
const createdSince = ref(
  props.initialFilters.created_since ? parseInt(props.initialFilters.created_since) : null
)
...
<template>
  <div class="flex flex-col gap-6 w-full md:w-[250px] md:min-w-[250px]">
    ...
    >
      <!-- Harga -->
      <div
        class="border-b border-custom-stroke/50 dark:border-white/5 last:border-0 pb-4 last:pb-0"
      >
        <button
      ...
      <!-- Kondisi -->
      <div
        class="border-b border-custom-stroke/50 dark:border-white/5 last:border-0 pb-4 last:pb-0 pt-4"
      >
        <button
          class="flex justify-between items-center w-full mb-3"
      ...
      <div class="pt-4">
        ...
        <div v-if="openSections.added" class="flex flex-wrap gap-2">
          <button
            ...
            :key="opt.value"
            :class="
              createdSince === opt.value
                ? 'bg-custom-blue/10 text-custom-blue border-custom-blue'
                : 'bg-white dark:bg-transparent text-custom-grey border-custom-stroke dark:border-white/10 hover:border-custom-blue'
            "
