  ...
  <div class="flex flex-col w-full md:w-[320px] border-r border-custom-stroke h-full bg-white">
    ...
    <div class="flex flex-col flex-1 overflow-y-auto">
      ...
      <button
        ...
        :key="user.id"
        :class="[
          'flex items-center gap-4 p-4 hover:bg-custom-background transition-all text-left border-b border-custom-stroke last:border-0 relative',
      ...
      >
        ...
        <div class="flex flex-col flex-1 min-w-0">
          ...
          <p
            ...
            :class="{
              'text-custom-black font-medium': (user.unread_count || 0) > 0,
