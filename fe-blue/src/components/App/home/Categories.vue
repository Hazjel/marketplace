                    ...
                    <div
                        ...
                        <div class="flex flex-col items-center gap-1 text-center">
                            <p
                                ...
                                {{ category.name }}</p>
                            <span
                                class="text-[10px] bg-gray-100 dark:bg-white/10 px-2 py-0.5 rounded-full text-custom-grey dark:text-gray-400 group-hover:bg-blue-50 dark:group-hover:bg-blue-500/20 group-hover:text-custom-blue dark:group-hover:text-blue-400 transition-colors">{{
