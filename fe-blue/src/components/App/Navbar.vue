      ...
      <div class="w-full max-w-[1920px] flex flex-col gap-6 px-4 md:px-7 mx-auto">
        ...
        >
          ...
          <div class="relative order-last md:order-0 w-full md:w-auto md:flex-1 search-container">
            ...
            >
              <img
                ...
                class="flex size-6 shrink-0 dark:brightness-0 dark:invert"
                alt="icon"
              />
              <input
                v-model="searchQuery"
            ...
            >
              ...
              <div v-if="showHistory && searchHistory.length > 0">
                ...
                >
                  <span class="text-xs font-bold text-custom-grey uppercase tracking-wider"
                    >Recent Searches</span
                  >
                  <button
                    class="text-xs font-semibold text-custom-red hover:underline"
                    @click="clearHistory"
                  >
                    Clear All
                  </button>
                ...
                <div class="flex flex-col">
                  ...
                  >
                    <div class="flex items-center gap-3">
                      <img
                        src="@/assets/images/icons/search-normal-grey.svg"
                        class="size-5 opacity-60 dark:brightness-0 dark:invert"
                        alt="history"
                      />
                      <span
          ...
          <div class="flex items-center gap-3 shrink-0 ml-auto md:ml-0 h-10 md:h-12">
            ...
            <div
              v-if="user"
              class="relative profile-dropdown-container z-50 h-full flex items-center"
              @mouseenter="showDropdownProfile = true"
              @mouseleave="showDropdownProfile = false"
            >
              <!-- Profile Trigger -->
              <button
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          ...
                          class="size-2 rounded-full bg-custom-green"
                        ></span>
                      </RouterLink>
                    </div>
