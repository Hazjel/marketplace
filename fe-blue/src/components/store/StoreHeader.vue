...
<template>
  <div
    class="w-full relative rounded-[32px] overflow-hidden bg-white/70 backdrop-blur-xl border border-white/50 shadow-xl transition-all duration-300"
  >
    <!-- Background Decoration -->
    <div
      class="absolute top-0 right-0 w-64 h-64 bg-custom-blue/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"
    ></div>
    <div
      class="absolute bottom-0 left-0 w-40 h-40 bg-orange-100 rounded-full blur-2xl translate-y-1/2 -translate-x-1/2 pointer-events-none"
    ></div>

    <div
      class="relative z-10 p-5 md:p-8 flex flex-col md:flex-row gap-6 md:gap-6 items-start md:items-center justify-between"
    >
      <!-- Left: Store Info -->
      <div class="flex items-start md:items-center gap-4 md:gap-6 flex-1 min-w-0 w-full">
        ...
        <div class="relative shrink-0">
          ...
          >
            <img
              src="@/assets/images/icons/verify-star.svg"
        ...
        <div class="flex flex-col gap-1 md:gap-2 flex-1 min-w-0">
          ...
          <div
            class="flex items-center gap-3 md:gap-4 text-custom-grey text-xs md:text-sm font-medium flex-wrap"
          >
            <div class="flex items-center gap-1.5">
              <img
                src="@/assets/images/icons/location-grey.svg"
                class="w-3.5 h-3.5 md:w-4 md:h-4 opacity-70"
                alt="Loc"
              />
