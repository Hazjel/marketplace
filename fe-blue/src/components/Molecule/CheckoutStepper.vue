    ...
    <div class="w-full max-w-[600px] mx-auto mb-8">
        <div class="relative flex justify-between items-center w-full">
            ...
            <div
                ...
                <!-- Progress Fill -->
                <div class="h-full bg-custom-blue transition-all duration-500"
            ...
            <div v-for="(step, index) in steps" :key="step.number"
                ...
                <div class="flex items-center justify-center size-8 md:size-10 rounded-full border-[3px] transition-all duration-300 relative bg-white z-10"
                    :class="[
                        currentStep > step.number ? 'bg-custom-blue border-custom-blue' :
                            currentStep === step.number ? 'bg-white border-custom-blue shadow-[0_0_0_4px_rgba(59,130,246,0.2)]' :
                                'bg-white border-gray-200'
                    ]">

                    <!-- Check Icon for Completed -->
                    <svg v-if="currentStep > step.number" xmlns="http://www.w3.org/2000/svg"
                        class="size-4 md:size-5 text-white" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <span v-else class="text-xs md:text-sm font-bold transition-colors"
