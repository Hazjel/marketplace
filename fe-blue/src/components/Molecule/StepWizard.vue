...
<template>
  <div class="w-full flex items-center justify-between mb-8 px-4 relative">
    ...
    <div
      class="absolute left-0 top-1/2 -translate-y-1/2 h-1 bg-custom-blue -z-10 transition-all duration-300"
      ...
      <div
        ...
        :class="[
          currentStep > index + 1
            ...
            : currentStep === index + 1
              ? 'bg-white border-custom-blue text-custom-blue ring-4 ring-blue-50'
