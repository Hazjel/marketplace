...
const specs = computed(() => [
    ...
    { label: 'Kategori', value: props.product?.product_category?.name, isLink: true, slug: props.product?.product_category?.slug },
