...
<template>
  <Card
    class="flex flex-col gap-4 bg-white rounded-2xl border-gray-100 shadow-sm hover:shadow-md transition-shadow"
  >
    <CardContent class="p-4 md:p-6 flex flex-col gap-4">
      <!-- Header: User & Rating -->
