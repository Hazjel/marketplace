    ...
    <div class="bg-white rounded-[24px] w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
      ...
      <div class="flex items-center justify-between p-6 border-b border-gray-100">
        ...
        >
          ...
          />
          <span
            v-if="$el?.querySelector?.('img')?.style?.display === 'none'"
      ...
      <div class="p-6 overflow-y-auto custom-scrollbar flex flex-col gap-6">
        ...
        <div class="flex flex-col items-center gap-2">
          ...
          <div class="flex gap-2">
            ...
            >
              <!-- Star Icon SVGs -->
              <svg
                v-if="i <= (tempRating || form.rating)"
                xmlns="http://www.w3.org/2000/svg"
                class="w-10 h-10 text-custom-orange fill-current"
                viewBox="0 0 24 24"
              >
                <path
              ...
              <svg
                v-else
                xmlns="http://www.w3.org/2000/svg"
                class="w-10 h-10 text-gray-300 fill-current"
                viewBox="0 0 24 24"
              >
                <path
                  d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"
        ...
        <div class="flex flex-col gap-2">
          ...
          <textarea
            ...
            placeholder="Ceritakan kepuasan Anda tentang kualitas produk dan pelayanan kami..."
          ></textarea>
        </div>
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="flex flex-wrap gap-2">
            <div
              ...
              :key="idx"
              class="relative w-20 h-20 rounded-xl overflow-hidden group border border-gray-200"
            >
              <img
              ...
              <button
                class="absolute top-1 right-1 bg-red-500 text-white rounded-full p-0.5 w-5 h-5 flex items-center justify-center text-xs opacity-0 group-hover:opacity-100 transition-opacity"
            ...
            <label
              ...
              class="w-20 h-20 rounded-xl border-2 border-dashed border-gray-300 flex flex-col items-center justify-center cursor-pointer hover:border-custom-blue hover:bg-blue-50 transition-colors"
            >
        ...
        <label class="flex items-center gap-3 cursor-pointer select-none">
          <input
            ...
            type="checkbox"
            class="w-5 h-5 rounded border-gray-300 text-custom-blue focus:ring-custom-blue"
          />
